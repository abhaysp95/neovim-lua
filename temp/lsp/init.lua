...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap('n', '<Leader>gf', '<cmd>lua vim.diagnostic.open_float()<CR>', opts)
  buf_set_keymap('n', '[d', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>', opts)
  buf_set_keymap('n', ']d', '<cmd>lua vim.lsp.diagnostic.goto_next()<CR>', opts)
  buf_set_keymap('n', '<Leader>gs', '<cmd>lua vim.diagnostic.show()<CR>', opts)
  ...
  -- lsp_extensions
  -- buf_set_keymap('n', '<Leader>le', [[<cmd>lua require'lsp_extensions'.inlay_hints()<CR>]], opts)
end
...
-- you can just put additional settings for other language servers here. e.g.,

-- require 'some_lsp'.setup {
--   default_config = {
--     cmd = {};
--     filetypes = {}
--     rootdir= function()
...
local servers = { 'clangd', 'cmake', 'cssls', 'emmet_ls', 'gopls', 'html', 'pyright', 'solc', 'jdtls', 'sumneko_lua', 'rust_analyzer', 'tsserver' }
